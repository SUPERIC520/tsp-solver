...
## [2026-05-25 22:52] - Benchmark N=100 (Refined Architecture)
- **Params**: seeds=8, kicks=1500, iterations=2, hk_iter=2000, max_opt=3
- **Results**: Gap=0.7422%, LB=27173.75, Best=27375.45, Time=13.96s
- **Status**: SUCCESS

## [2026-05-25 22:52] - Benchmark N=500 (Refined Architecture)
- **Params**: seeds=8, kicks=1500, iterations=2, hk_iter=2000, max_opt=3
- **Results**: Gap=1.3939%, LB=54806.82, Best=55570.76, Time=8.05s
- **Status**: SUCCESS

## [2026-05-25 22:52] - Benchmark N=1000 (Refined Architecture)
- **Params**: seeds=8, kicks=1500, iterations=2, hk_iter=2000, max_opt=3
- **Results**: Gap=1.7829%, LB=77657.18, Best=79041.76, Time=9.73s
- **Status**: SUCCESS

## [2026-05-25 22:53] - Benchmark N=5000 (Refined Architecture)
- **Params**: seeds=8, kicks=5000, iterations=2, hk_iter=2000, max_opt=3
- **Results**: Gap=100.0000%, LB=-inf, Best=259493.45, Time=12.07s
- **Status**: FAILURE

## [2026-05-25 22:54] - Benchmark N=5000 (Refined Architecture)
- **Params**: seeds=8, kicks=5000, iterations=2, hk_iter=2000, max_opt=3
- **Results**: Gap=100.0000%, LB=-inf, Best=259531.47, Time=14.79s
- **Status**: FAILURE

## [2026-05-25 22:56] - Benchmark N=5000 (Refined Architecture)
- **Params**: seeds=8, kicks=5000, iterations=2, hk_iter=2000, max_opt=3
- **Results**: Gap=1.4193%, LB=254787.36, Best=258403.43, Time=35.14s
- **Status**: SUCCESS
