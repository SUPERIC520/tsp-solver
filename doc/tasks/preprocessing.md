...
- [x] **[T2.1]** Clean up Delaunay neighbor filtering remnants from [preprocessing.py](file:///C:/Users/eric2/Desktop/Classes/Math%20147/TSP_EXP_2/src/core/preprocessing.py) (Delete `_filter_nearest_neighbors` and any Delaunay variables).
