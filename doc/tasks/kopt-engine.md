...
- [x] **[T4.1]** Search and completely remove `locked_edges` from all function signatures, variable layouts, and local search routines inside [kopt_engine.py](src/core/kopt_engine.py).
