...
- [x] **[T5.1]** Reimplement worker concurrency in [orchestration.py](file:///C:/Users/eric2/Desktop/Classes/Math%20147/TSP_EXP_2/src/core/orchestration.py) using `multiprocessing.Array('i', num_seeds)` for low-overhead progress counters, eliminating the Manager proxy process.
