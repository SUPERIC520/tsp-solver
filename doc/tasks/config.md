...
- [x] **[T1.1]** Create the configuration file at `src/config.py` defining the global constants:
...
- [x] **[T1.2]** Create configuration import and runtime parameter override unit tests in `tests/test_config.py` (Verify parameter overrides function properly in a non-JIT environment).
